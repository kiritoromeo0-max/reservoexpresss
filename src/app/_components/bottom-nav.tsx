...
export function BottomNav() {
  ...
  return (
    <nav className="shrink-0 border-t border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 px-1 pt-1 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
