...
import { Avatar, categoryLabel } from "../ui-helpers";
      ...
      <div className="bg-primary text-primary-foreground px-5 pt-6 pb-8 rounded-b-3xl">
        <div className="flex flex-col items-center text-center">
          ...
          <span className="text-xs bg-white/15 px-2.5 py-0.5 rounded-full mt-1">
            Prestataire · {categoryLabel(user.provider?.category ?? "autre")}
          </span>
        </div>
      </div>
      ...
      <div className="px-4 -mt-4">
        <div className="rounded-xl border border-border bg-card divide-y divide-border shadow-sm">
          <InfoRow
            ...
            label="Activite"
            value={user.provider?.businessName ?? user.name}
          />
          <InfoRow
      ...
      <div className="px-4 mt-4 space-y-3">
        <div className="rounded-xl border border-border bg-card divide-y divide-border overflow-hidden">
          ...
          <MenuItem
            ...
            label="Notifications"
            onClick={() => resetTo("provider-notifications")}
          />
          <MenuItem
          ...
          <MenuItem
            ...
            onClick={() => showToast("ReservoExpress - Espace prestataire", "info")}
          />
        </div>
